...
class LoginFormAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function __construct(UrlGeneratorInterface $urlGenerator, UserProviderInterface $userProvider)
    {
        ...
        $this->userProvider = $userProvider;  // Le UserProvider pour charger l'utilisateur
    }
    ...
    public function authenticate(Request $request): Passport
    {
        ...
        // Créer un badge pour l'utilisateur à partir de l'email
        return new Passport(
            new UserBadge($email, function ($userIdentifier) {
                // Retourne l'utilisateur à partir de l'email
